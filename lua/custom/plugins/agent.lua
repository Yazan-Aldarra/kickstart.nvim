return {
  ...
  --   },
  --   opts = {
  --     -- Set your default adapter (provider)
  --     strategies = {
  --       chat = {
  --         adapter = 'copilot',
  --       },
  ...
  --       },
  --     },
  --     -- Optional: Configure the Copilot adapter's default model
  --     adapters = {
  --       copilot = function()
  --         return require('codecompanion.adapters').extend('copilot', {
  --           schema = {
  --             model = {
  --               default = 'gpt-4o', -- Set your preferred default model here
  --             },
  --           },
  --         })
  --       end,
  --     },
  --   },
  --   -- Suggested keymaps to get started
  --   keys = {
  --     { '<C-a>', '<cmd>CodeCompanionActions<cr>', mode = { 'n', 'v' }, desc = 'CodeCompanion Actions' },
  --     { '<C-s>', '<cmd>CodeCompanionChat Toggle<cr>', mode = { 'n', 'v' }, desc = 'Toggle CodeCompanion Chat' },
  --     { '<C-i>', '<cmd>CodeCompanion<cr>', mode = { 'n', 'v' }, desc = 'Inline CodeCompanion' },
      ...
      require('opencode').setup {
        ...
        keymap = {
          editor = {
            ...
            ['<leader>o-'] = { 'diff_open' }, -- Opens a diff tab of a modified file since the last opencode prompt
